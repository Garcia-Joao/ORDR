  ...
  return (
    <div className="relative" ref={containerRef}>
      <button
        ...
        className="flex items-center gap-3 rounded-xl border border-border bg-background px-3 py-2 hover:bg-accent transition-colors"
      >
        {user?.photoBase64 ? (
          <img
          ...
          <div className="h-9 w-9 rounded-full bg-primary/10 text-primary flex items-center justify-center text-sm font-semibold border border-border">
            {getInitial(user)}
          </div>
        )}
