              ...
              {visibleProducts.map((product) => {
                ...
                return (
                  <button
                    ...
                    className="group flex min-h-[145px] flex-col rounded-2xl border border-border bg-card p-4 text-left transition-all hover:border-primary/20 hover:bg-secondary/40"
                  >
