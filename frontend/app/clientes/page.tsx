...
function CustomerModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4">
      <div className="max-h-[92vh] w-full max-w-6xl overflow-hidden rounded-2xl border border-border bg-card shadow-2xl">
        ...
        >
          ...
          <aside className="flex flex-col overflow-y-auto border-t border-border bg-primary/5 p-5 lg:border-l lg:border-t-0">
