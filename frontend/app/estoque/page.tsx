  ...
  return (
    <div className="h-full flex flex-col overflow-hidden">
      <div className="flex items-center justify-between px-6 py-4 border-b border-border bg-card">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="h-10 px-4 rounded-lg border border-border bg-background text-foreground hover:bg-secondary disabled:opacity-50 inline-flex items-center gap-2"
            title={
          ...
          <button
            ...
            className="h-10 px-4 rounded-lg bg-primary text-primary-foreground hover:bg-primary/90 inline-flex items-center gap-2"
          >
      ...
      <div className="px-6 py-4 border-b border-border bg-card">
        <div className="grid lg:grid-cols-[minmax(0,1fr)_190px] gap-4 items-start">
          <div className="space-y-3 min-w-0">
            ...
            <div className="flex items-stretch gap-2 flex-wrap">
              ...
              <button
                ...
                className="h-[60px] px-4 rounded-xl border border-border bg-background hover:bg-secondary text-sm text-foreground"
              >
                Limpar filtros
              </button>
            </div>
      ...
      <div className="flex-1 min-h-0 p-6 overflow-hidden">
        <div className="h-full bg-card rounded-xl border border-border overflow-auto">
                  ...
                  >
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center justify-end gap-2">
                        ...
                        <ActionIconButton
                          onClick={() =>
                            handleOpenMovement(product, "adjustment")
                          }
      ...
      {showHistoryModal && selectedProduct && (
        <div className="fixed inset-0 z-50 bg-black/40 flex items-center justify-center p-4">
          <div className="w-full max-w-2xl rounded-2xl bg-card border border-border shadow-xl overflow-hidden max-h-[90vh] flex flex-col">
      ...
      {showRecipeModal && selectedProduct && (
        <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center p-4">
          <div className="w-full max-w-6xl rounded-2xl bg-card border border-border shadow-xl overflow-hidden max-h-[92vh] flex flex-col">
            <div className="flex items-center justify-between px-5 py-4 border-b border-border">
              <div className="flex items-center gap-3">
