...
export default function RelatoriosPage() {
  ...
  return (
    <div className="flex h-full flex-col overflow-hidden bg-gradient-to-br from-background via-background to-cyan-500/5">
      <header className="border-b border-border bg-card/95 px-6 py-4 shadow-sm backdrop-blur">
      ...
      <div className="grid min-h-0 flex-1 grid-cols-[280px_1fr] overflow-hidden">
        <aside className="overflow-y-auto border-r border-border bg-card/60 p-4">
...
function DayDetailsModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/55 p-4">
      <div className="flex max-h-[92vh] w-full max-w-6xl flex-col overflow-hidden rounded-3xl border border-border bg-card shadow-2xl">
