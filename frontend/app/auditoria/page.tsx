    ...
    <div className="min-h-full bg-background p-4 text-foreground md:p-6">
      <div className="mx-auto flex max-w-7xl flex-col gap-6">
        <header className="overflow-hidden rounded-3xl border bg-card shadow-sm">
          ...
          <div className="grid border-t bg-muted/30 md:grid-cols-3">
        ...
        <section className="rounded-3xl border bg-card p-4 shadow-sm">
          <div className="grid gap-3 lg:grid-cols-[1.2fr_0.8fr_0.8fr_0.7fr_0.7fr_auto]">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="h-11 rounded-2xl bg-primary px-4 text-sm font-bold text-primary-foreground shadow-sm transition hover:opacity-90"
              >
                Filtrar
              </button>
              <button
                ...
                className="h-11 rounded-2xl border px-4 text-sm font-bold transition hover:bg-muted"
              >
                Limpar
              </button>
            </div>
      ...
      {selectedLog && (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/50 p-4 backdrop-blur-sm">
          <div className="flex max-h-[92vh] w-full max-w-5xl flex-col overflow-hidden rounded-3xl border bg-card shadow-2xl">
