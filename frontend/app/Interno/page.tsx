...
export default function InternoPage() {
  ...
  return (
    <div className="h-full flex flex-col overflow-hidden bg-background relative">
      {toast.visible && (
        <div className="absolute top-4 right-4 z-50 w-[340px] rounded-xl border border-border bg-card shadow-lg p-4">
      ...
      <div
        className={`grid gap-0 flex-1 overflow-hidden ${isCustomerSidebarCollapsed
          ? 'grid-cols-[72px_1fr_460px]'
          : 'grid-cols-[320px_1fr_460px]'
          }`}
      >
        <aside className="border-r border-border bg-card flex flex-col min-h-0">
          <div className="p-3 border-b border-border flex items-center justify-between gap-2">
            ...
            <button
              ...
              className="h-10 w-10 rounded-lg border border-border bg-background hover:bg-secondary flex items-center justify-center shrink-0"
            >
              {isCustomerSidebarCollapsed ? (
        ...
        <main className="flex flex-col min-h-0 overflow-hidden">
          {!selectedCustomer ? (
            ...
            <>
              ...
              <div className={`flex-1 overflow-hidden ${selectedCustomerIsDisabled ? 'pointer-events-none opacity-50 grayscale' : ''}`}>
                <ProductGrid
        ...
        <aside className="border-l border-border bg-card min-h-0 overflow-hidden flex flex-col">
          {!selectedCustomer ? (
