...
internalCustomersRoutes.get('/', async (_req, res) => {
  try {
...
internalCustomersRoutes.get('/:id/orders/today', async (req, res) => {
  try {
...
internalCustomersRoutes.get('/:id/orders/pending', async (req, res) => {
  try {
    const customerId = getRouteParam(req.params.id, 'id')
...
internalCustomersRoutes.post('/:id/orders/pay', async (req, res) => {
  try {
    const customerId = getRouteParam(req.params.id, 'id')
