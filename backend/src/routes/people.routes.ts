...
peopleRoutes.get('/functions', async (_req, res) => {
  try {
...
peopleRoutes.post('/functions', async (req, res) => {
  try {
...
peopleRoutes.patch('/:id/disable', async (req, res) => {
  try {
...
peopleRoutes.patch('/:id/restore', async (req, res) => {
  try {
